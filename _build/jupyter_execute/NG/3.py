...
# 
# ````{margin}
# ![Lambert Quadrilateral](Fig4.png)
...
# 
# ````{margin}
# ![Saccheri Quadrilateral](Fig5.png)
...
# 
# ![Non-Euclidean Geometry: A Summary](https://upload.wikimedia.org/wikipedia/commons/thumb/7/78/Noneuclid.svg/1920px-Noneuclid.svg.png)
# 
# Boyai wrote to his father, explaining the quest:

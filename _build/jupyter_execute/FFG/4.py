...
# ```
# Young's Geometry is identical to Fano's Geometry except that Axiom 5 is different. Let's investigate what happens using the same undefined and defined terms and four of the same axioms:
# 

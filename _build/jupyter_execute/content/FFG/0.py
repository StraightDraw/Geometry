...
# 1. An axiomatic system must contain a set of technical terms that are deliberately chosen as *undefined terms* and are subject to the interpretation of the reader.
# 2. All other technical terms of the system are *defined terms* whose definition rely upon the undefined terms.
# 3. The *axioms* of the system are a set of statements dealing with the defined and undefined terms and will remain unproven. The word "postulate" is a synonym and is often used in place of the word axiom. Euclid, for example, used postulates rather than axioms.
# 4. All other statements must be logical consequences of the axioms. These derived statements are called the *theorems* of the axiomatic system.
# 
...
# 
# <iframe width="560" height="315" src="https://www.youtube.com/embed/LPET_HhN0VM" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

# Mathematicians generally prefer independent sets of axioms, but independent systems can be tedious to work with because each result (many of which seem to be trivially true) must be proven individually. This labor-intensive process can be shortened by taking a few essential theorems as axioms. Though the system will be dependent, students of mathematics will be able to advance quickly to the proof of non-trivial results.
# 

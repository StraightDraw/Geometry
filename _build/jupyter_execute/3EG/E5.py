...
````{margin}
```{figure} ../images/InscribedAngles.png
---
width: 100%
name: InscribedAngle 
---
...
10. **Tangent-Chord Angle Theorem**. If $\overleftrightarrow{AB}$ is tangent to a circle at $A$, and if $\overline{AC}$ is a chord of the circle with $m\overset{\Huge\frown}{APC}=x^{\circ}$, then $m\angle BAC=\frac{x^{\circ}}{2}$.
    ...
    ````{figure} ../images/TangentChord.png
    ---
    width: 50%
    name: TangentChord
    ---
...
11. **Two-Tangent Angle Theorem**. The measure of an angle formed by two tangents drawn to a circle is one-half the positive difference of the measures of the intercepted arcs.

    ````{figure} ../images/TwoTangent.png
    ---
    width: 55%
    name: TwoTangent
    ---
...
12. **Corollary to the Two-Tangent Angle Theorem**. Tangent segments drawn to a circle from the same (exterior) point are congruent.
13. **Chord Segment Product Theorem**. If two chords of a circle intersect, the products of the lengths of the segments of one chord is equal to the product of the lengths of the segments of the other.

    ````{figure} ../images/ChordSegmentProduct.png
    ---
    width: 35%
    name: TwoTangent
    ---
...
15. **Secant Segment Product Theorem**. If two secant lines are drawn to a circle from the same exterior point, then the product of the length of the secant segment and the lenth of its exterior portion is the same for both secants.
    ...
    ````{figure} ../images/SegmentProduct.png
    ---
    width: 45%
    name: TwoTangent
    ---

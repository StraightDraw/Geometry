# 3.4 Right Triangles and the Pythagorean Theorem

The following theorem establish a few important results about right triangles. Now that we have similarity defined, we can use it to prove the Pythaogrean Theorem. The area-based proof of the Pythagorean Theorem is shown above, but the similarity proof demonstrates the close relationship between the Pythagorean Theorem and the Geometric Mean Theorem.
